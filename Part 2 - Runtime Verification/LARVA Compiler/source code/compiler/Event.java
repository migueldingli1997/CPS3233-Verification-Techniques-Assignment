...
//				sb.append("*");
			...
			{
				sb.append(") throwing (");
				if (exception != null && variables.containsKey(exception.text) && variables.get(exception.text).type != null)
					sb.append(variables.get(exception.text).getVariableType() + " " + variables.get(exception.text).getVariableName());
				sb.append(") : (");
			}
